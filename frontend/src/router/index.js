...
const routes = [
  ...
  { path: '/exams/:id/monitor', component: () => import('../views/ExamMonitor.vue'), meta: { role: 'teacher', module: 'exam' } },
  { path: '/exams/:id/analysis', component: () => import('../views/ExamAnalysis.vue'), meta: { role: 'teacher', module: 'exam' } },
